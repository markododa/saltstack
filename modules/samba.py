            ...
            for x in arr:
                ...
                if len(tbl['defaults']) > 0:
                    for d in tbl['defaults']:
                        json[d['key']] = d['value'] 
                data.append(json)
        users_panel['tbl_source'][key]['source'] = data
    panel = {
