...
#        users_panel = f.read()
    ...
    if panel_name == "directory.list_logins":
        return users_panel
    if panel_name == "directory.groups":
        ...
        return users_panel
    if panel_name == "directory.org_units":
