...
def list_users2():
    arr = va_samba_api.list_users()['users']
    cols = ["username", "name", "password_expiry", "last_logon", "computer", "ip_address"]
    data = []
    for x in arr:
        d = {}
        for col in cols:
