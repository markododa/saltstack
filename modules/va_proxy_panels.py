panels = {
    "proxy.usergroups": {
        ...
        "content": [{
            ...
            "panels": {
                "list_logins": "proxy.list_logins",
                "manage_user_membership": "proxy.manage_user_membership",
                "edit_user_details": "proxy.edit_user_details"
            },
            "actions": [{
                        # "name": "Edit user",
                        # "action": "edit_user"
    ...
    "proxy.groups": {
        ...
        "content": [{
            ...
            "panels": {
                "list_group_members": "proxy.list_group_members"
            },
            "actions": [{
                        "name": "List members",
    ...
    "proxy.org_units": {
        ...
        "content": [{
                ...
                "modal": {
                    ...
                    "content": [{
                        ...
                        "elements": [{
                            ...
                            "type": "Paragraph",
                            "name": "Organizational units helps you orginize items in Active proxy."
                        }
                        ]
                    }
                    ]
            ...
            "panels": {
                    "get_ou_members": "proxy.ou_members"
            },
            "columns": [{
                        "key": "name",
                        "label": "Name"
